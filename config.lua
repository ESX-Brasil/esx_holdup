...
Config.Marker = {
	r = 250, g = 0, b = 0, a = 100,  -- cor vermelha
	x = 1.0, y = 1.0, z = 1.5,       -- minúsculo, cilíndrico formado círculo
	DrawDistance = 15.0, Type = 1    -- tipo de círculo padrão, baixa distância de tração devido à área interna
}

Config.PoliceNumberRequired = 2
Config.TimerBeforeNewRob    = 1800 -- O temporizador de cooldown em uma loja após o roubo foi concluído / cancelado, em segundos

Config.MaxDistance    = 20   -- distância máxima do roubo, indo mais longe dele vai cancelar o roubo
Config.GiveBlackMoney = true -- dar dinheiro sujo? Se desativado, ele dará dinheiro limpo
